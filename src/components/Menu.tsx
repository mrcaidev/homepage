    ...
    <>
      ...
      {isOpen && (
        <div class="relative -z-10">
          <div class="flex flex-col justify-center items-center gap-12 fixed top-0 left-0 w-screen h-screen px-8 py-20 bg-normal border-b border-b-slate-700 animate-[menu_1s_ease]">
